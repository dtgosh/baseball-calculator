...
export const initRoster = () => ({
	away: {
		bat: bat([
			['김지환', '555', '151', '58', '2', '9', '45', '5', '5', '21', '5'],
			['박세진', '555', '144', '58', '2', '9', '45', '5', '5', '14', '4'],
			['이현우', '555', '148', '76', '2', '11', '45', '5', '5', '8', '3'],
			['최민준', '555', '155', '74', '2', '11', '45', '5', '5', '5', '2'],
			['정재윤', '555', '138', '60', '2', '9', '45', '5', '5', '11', '3'],
			['오승민', '555', '133', '51', '1', '7', '45', '5', '5', '6', '2'],
			['한도윤', '555', '129', '43', '1', '7', '45', '5', '5', '9', '3'],
			['임규현', '555', '125', '41', '1', '6', '45', '5', '5', '4', '2'],
			['송지호', '555', '121', '35', '1', '5', '45', '5', '5', '12', '4'],
		]),
		arms: arm([
		...
		bench: bat([
			['강태민', '168', '39', '13', '0', '2', '14', '2', '2', '3', '1'],
			['유정호', '168', '38', '11', '0', '2', '14', '2', '2', '5', '2'],
			['신재웅', '168', '37', '9', '0', '2', '14', '2', '2', '2', '1'],
			['곽민서', '168', '36', '11', '0', '1', '14', '2', '2', '6', '2'],
		]),
	},
	home: {
		bat: bat([
			['이강준', '555', '147', '56', '2', '9', '45', '5', '5', '17', '4'],
			['김태오', '555', '143', '56', '2', '8', '45', '5', '5', '12', '3'],
			['박준서', '555', '151', '66', '2', '10', '45', '5', '5', '6', '2'],
			['최우진', '555', '154', '70', '2', '10', '45', '5', '5', '4', '2'],
			['장하람', '555', '136', '55', '2', '9', '45', '5', '5', '9', '3'],
			['윤세찬', '555', '132', '49', '1', '7', '45', '5', '5', '7', '2'],
			['강민재', '555', '128', '43', '1', '6', '45', '5', '5', '5', '2'],
			['조현탁', '555', '124', '35', '1', '6', '45', '5', '5', '3', '1'],
			['백승우', '555', '122', '35', '1', '5', '45', '5', '5', '8', '3'],
		]),
		arms: arm([
		...
		bench: bat([
			['남기훈', '168', '39', '12', '0', '2', '14', '2', '2', '2', '1'],
			['도상원', '168', '38', '10', '0', '2', '14', '2', '2', '4', '2'],
			['문진우', '168', '37', '9', '0', '2', '14', '2', '2', '1', '1'],
			['서병규', '168', '36', '10', '0', '1', '14', '2', '2', '3', '1'],
		]),
	},
});
